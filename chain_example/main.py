...
def prompt_chainable_poc():
    ...
    result, context_filled_prompts = MinimalChainable.run(
        context={"topic": "Duendes", "output": "Powerpoint slides"},
        ...
        prompts=[
            ...
            # prompt #3
            """Based on the BLOG_TITLE and BLOG_HOOK, write a Python program which generates five to seven {{output}} about the topic.
